# seaweedfs-operator (legacy monolithic chart)

> **Recommended:** For split-chart install, use [`../README.md`](../README.md) and `../install.sh`.  
> (`seaweedfs-operator-crds` → `seaweedfs-operator` → `seaweedfs-storage` → `seaweedfs` → `seaweedfs-csi-driver`)
